...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">CONNECT</a>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpeg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to CONNECT</h1>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">CONNECT Services</h3>
      <p>
        CONNECT Services is India’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        CONNECT Pvt Ltd, <br>
        Sec IV, JEPPIYAR NAGAR <br>
        chennai - 600051 <br>
        Phone: +917358036463 <br>
        <a href="#" target="_blank">www.CONNECT.com</a> <br>

        <br><br>
        <strong>chennai Branch:</strong> <br>
        CONNECT Pvt Ltd, <br>
        Ashok Nagar, TAMIL NADU <br>
        CHENNAI - 600002 <br>
        Phone: +7358036463 <br>
        <a href="#" target="_blank">www.CONNECT.com</a> <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by TEAM SV &copy; 2023.
          </small>
